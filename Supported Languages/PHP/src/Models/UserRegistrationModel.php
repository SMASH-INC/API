 ...
 */
class UserRegistrationModel implements JsonSerializable
{
    /**
    ...
    public function __construct()
    {
        if (14 == func_num_args()) {
            ...
            $this->countrycode = func_get_arg(7);
            $this->address     = func_get_arg(8);
            $this->a           = func_get_arg(9);
            $this->sa          = func_get_arg(10);
            $this->c           = func_get_arg(11);
            $this->s           = func_get_arg(12);
            $this->z           = func_get_arg(13);
        }
    }
