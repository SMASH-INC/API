 ...
 */
class UserRegistrationModelResponse implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var UserProfileInformationModel $info public property
     */
    public $info;
     ...
     * @param UserProfileInformationModel $info    Initialization value for $this->info
     */
