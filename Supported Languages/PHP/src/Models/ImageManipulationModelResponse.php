 ...
 */
class ImageManipulationModelResponse implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var string $moderated public property
     */
    public $moderated;
     ...
     * @param string $moderated Initialization value for $this->moderated
