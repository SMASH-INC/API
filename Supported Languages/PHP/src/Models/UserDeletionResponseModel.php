 ...
 */
class UserDeletionResponseModel implements JsonSerializable
{
    /**
     ...
     * @todo Write general description for this property
     * @required
     * @var string $deleted public property
     */
    public $deleted;
     ...
     * @param string $deleted Initialization value for $this->deleted
