...
{
    /**
     * @var DataManipulation The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return DataManipulation The *Singleton* instance.
     */
     ...
     * @param string $options['data']      Data URL, data as a query string, or direct upload
     * @param string $options['transform'] Transformations to perform
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function httpsApiRestShApiD(
        $options
    ) {
        //check that all required arguments are provided
        if (!isset($options['data'], $options['transform'])) {
        ...
        return $mapper->mapClass($response->body, 'SMASHLib\\Models\\DataManipulationModelResponse');
    }
