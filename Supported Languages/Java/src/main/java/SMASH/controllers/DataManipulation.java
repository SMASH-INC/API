...
public class DataManipulation extends BaseController {    
     ...
     * @return    Returns the DataManipulationModelResponse response from the API call 
     */
    public DataManipulationModelResponse httpsApiRestShApiD(
                final HttpsApiRestShApiDInput input
    ) throws Throwable {
        APICallBackCatcher<DataManipulationModelResponse> callback = new APICallBackCatcher<DataManipulationModelResponse>();
        httpsApiRestShApiDAsync(input, callback);
    ...
    public void httpsApiRestShApiDAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4749983460119638804L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5128196171945993502L;
            {
