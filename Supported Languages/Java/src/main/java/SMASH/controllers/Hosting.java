...
public class Hosting extends BaseController {    
     ...
     * @return    Returns the HostingModelResponse response from the API call 
     */
    public HostingModelResponse hostingSetup(
                final HostingSetupInput input
    ) throws Throwable {
        APICallBackCatcher<HostingModelResponse> callback = new APICallBackCatcher<HostingModelResponse>();
        hostingSetupAsync(input, callback);
    ...
    public void hostingSetupAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5069006467111703795L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5675406168617581667L;
            {
