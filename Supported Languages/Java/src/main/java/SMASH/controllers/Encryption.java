...
public class Encryption extends BaseController {    
     ...
     * @return The singleton instance of the Encryption class 
     */
     ...
     * @param    DataAndFileEncryptionInput    Object containing request parameters
     * @return    Returns the EncryptionModelResponse response from the API call 
     */
    public EncryptionModelResponse dataAndFileEncryption(
                final DataAndFileEncryptionInput input
    ) throws Throwable {
        APICallBackCatcher<EncryptionModelResponse> callback = new APICallBackCatcher<EncryptionModelResponse>();
        dataAndFileEncryptionAsync(input, callback);
     ...
     */
    public void dataAndFileEncryptionAsync(
                final DataAndFileEncryptionInput input,
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5249882301305161735L;
            {
                    put( "data", input.getData() );
                    put( "method", input.getMethod() );
                    put( "bit", input.getBit() );
            }});
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5746621821237776661L;
            {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            ...
                            EncryptionModelResponse _result = APIHelper.deserialize(_responseBody,
                                                        new TypeReference<EncryptionModelResponse>(){});
