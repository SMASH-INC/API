...
public class Verification extends BaseController {    
     ...
     * @return    Returns the VerifyAddressResponse response from the API call 
     */
    public VerifyAddressResponse userAddressVerification(
                final UserAddressVerificationInput input
    ) throws Throwable {
        APICallBackCatcher<VerifyAddressResponse> callback = new APICallBackCatcher<VerifyAddressResponse>();
        userAddressVerificationAsync(input, callback);
    ...
    public void userAddressVerificationAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5351485994487198979L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4674786496046983093L;
            {
     ...
     * @return    Returns the VerifyUserModelResponse response from the API call 
     */
    public VerifyUserModelResponse userVerificationResponse(
                final UserVerificationResponseInput input
    ) throws Throwable {
        APICallBackCatcher<VerifyUserModelResponse> callback = new APICallBackCatcher<VerifyUserModelResponse>();
        userVerificationResponseAsync(input, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void userVerificationResponseAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5708478459699789476L;
            {
                    put( "user", input.getUser() );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5021272385929275175L;
            {
                    put( "user-agent", "SMASH" );
            }
        };
     ...
     * @return    Returns the VerifyModelResponse response from the API call 
     */
    public VerifyModelResponse userVerification(
                final String user
    ) throws Throwable {
        APICallBackCatcher<VerifyModelResponse> callback = new APICallBackCatcher<VerifyModelResponse>();
        userVerificationAsync(user, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void userVerificationAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5103424464513667775L;
            {
                    put( "user", user );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4899296460342820460L;
            {
                    put( "user-agent", "SMASH" );
            }
        };
