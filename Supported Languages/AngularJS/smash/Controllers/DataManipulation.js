...
angular.module('SMASH')
    ...
    function DataManipulation($q, Configuration, Servers, HttpClient, APIHelper, BaseController) {
        return {
            /**
             ...
             *
             * @return {promise<Data Manipulation Model Response>}
             */
            httpsApiRestShApiD: function (input) {
                ...
                _response.then(function success(_result) {
                    ...
                    parsed = BaseController.getObjectMapper().mapObject(parsed, 'DataManipulationModelResponse');
                    _result.body = parsed;
