...
angular.module('SMASH')
    .factory('Hosting', ['$q', 'Configuration', 'Servers', 'HttpClient', 'APIHelper', 'BaseController', Hosting
    ]);

    function Hosting($q, Configuration, Servers, HttpClient, APIHelper, BaseController) {
        return {
            /**
             ...
             *
             * @return {promise<Hosting Model Response>}
             */
            hostingSetup: function (input) {
                ...
                if (input.app === null || input.app === undefined) {
                    _deffered.reject({
                        errorMessage: 'The property `app` in the input object cannot be null.',
                        errorCode: -1
                    });
                    _missingArgs = true;
                ...
                var _queryBuilder = _baseUri + '/s/h';
                ...
                _response.then(function success(_result) {
                    ...
                    parsed = BaseController.getObjectMapper().mapObject(parsed, 'HostingModelResponse');
                    _result.body = parsed;
