...
angular.module('SMASH')
    .factory('CDN', ['$q', 'Configuration', 'Servers', 'HttpClient', 'APIHelper', 'BaseController', CDN
    ]);

    function CDN($q, Configuration, Servers, HttpClient, APIHelper, BaseController) {
        return {
            /**
             * CDN Push Zone API
             *
             ...
             *
             * @return {promise<CDN Push Model Response>}
             */
            cDNPushZone: function (input) {
                ...
                var _queryBuilder = _baseUri + '/s/c/push';
                ...
                _response.then(function success(_result) {
                    ...
                    parsed = BaseController.getObjectMapper().mapObject(parsed, 'CDNPushModelResponse');
                    _result.body = parsed;
             ...
             * access
             *
             * @return {promise<CDN Pull Model Response>}
             */
            cDNPullZone: function (input) {
                // Assign default values
                input = input || {};
                ...
                //prepare query string for API call
                var _baseUri = Configuration.getBaseUri(Servers.PATH);
                var _queryBuilder = _baseUri + '/s/c/pull';
                ...
                _response.then(function success(_result) {
                    var parsed = _result.body;
                    parsed = BaseController.getObjectMapper().mapObject(parsed, 'CDNPullModelResponse');
                    _result.body = parsed;
                    _deffered.resolve(_result);
                }, function error(_result){
                    // Error handling for custom HTTP status codes
