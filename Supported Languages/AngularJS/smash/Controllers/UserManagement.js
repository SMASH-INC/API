...
angular.module('SMASH')
    ...
    function UserManagement($q, Configuration, Servers, HttpClient, APIHelper, BaseController) {
        return {
            /**
             * Get User Info API
             *
             ...
             *
             * @return {promise<User Information Model Response>}
             */
            getUserInfo: function (user) {
                ...
                var _queryBuilder = _baseUri + '/u/i';
                ...
                _response.then(function success(_result) {
                    ...
                    parsed = BaseController.getObjectMapper().mapObject(parsed, 'UserInformationModelResponse');
                    _result.body = parsed;
             ...
             * endpoint
             *
             * @return {promise<User Update Model Response>}
             */
            updateUser: function (input, queryParameters) {
                ...
                if (input.user === null || input.user === undefined) {
                    ...
                    _deffered.reject({
                        errorMessage: 'The property `avatar` in the input object cannot be null.',
                        errorCode: -1
                    });
                    _missingArgs = true;
                } else if (input.customInput === null || input.customInput === undefined) {
                    _deffered.reject({
                        errorMessage: 'The property `customInput` in the input object cannot be null.',
                        errorCode: -1
                    });
                    _missingArgs = true;
                }
                ...
                //prepare query string for API call
                var _baseUri = Configuration.getBaseUri(Servers.PATH);
                var _queryBuilder = _baseUri + '/u/u';
                ...
                _response.then(function success(_result) {
                    var parsed = _result.body;
                    parsed = BaseController.getObjectMapper().mapObject(parsed, 'UserUpdateModelResponse');
                    _result.body = parsed;
                    _deffered.resolve(_result);
                }, function error(_result){
                    // Error handling for custom HTTP status codes
             ...
             *
             * @return {promise<User Deletion Response Model>}
             */
            deleteUser: function (user) {
                ...
                //prepare query string for API call
                var _baseUri = Configuration.getBaseUri(Servers.PATH);
                var _queryBuilder = _baseUri + '/u/d';
                ...
                _response.then(function success(_result) {
                    var parsed = _result.body;
                    parsed = BaseController.getObjectMapper().mapObject(parsed, 'UserDeletionResponseModel');
                    _result.body = parsed;
                    _deffered.resolve(_result);
                }, function error(_result){
                    // Error handling for custom HTTP status codes
