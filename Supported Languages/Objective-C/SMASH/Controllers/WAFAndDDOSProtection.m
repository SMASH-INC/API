//
//  WAFAndDDOSProtection.m
//  SMASH
//
//  This file was automatically generated for SMASH by SMASH v2.0 ( https://smashlabs.io )
//
#import "WAFAndDDOSProtection.h"
#import "CustomAuthUtility.h"

@implementation WAFAndDDOSProtection
                ...
                completionBlock:(CompletedGetWAFConfiguration) onCompleted
{
    ...
    if (input.name == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'name' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.rule == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'rule' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    [_queryBuilder appendString: @"/s/w/c"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             WAFConfigurationModelResponse* _result = (WAFConfigurationModelResponse*) [APIHelper jsonDeserialize: _strResult
                toClass: WAFConfigurationModelResponse.class];
                ...
                completionBlock:(CompletedGetWAFCreation) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/s/w"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             //return _response to API caller
             NSString* _strResult = [(HttpStringResponse*)_response body];
             WAFCreationModelResponse* _result = (WAFCreationModelResponse*) [APIHelper jsonDeserialize: _strResult
                toClass: WAFCreationModelResponse.class];
