...
//
#import "DataManipulation.h"
#import "CustomAuthUtility.h"

@implementation DataManipulation
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             DataManipulationModelResponse* _result = (DataManipulationModelResponse*) [APIHelper jsonDeserialize: _strResult
                toClass: DataManipulationModelResponse.class];
