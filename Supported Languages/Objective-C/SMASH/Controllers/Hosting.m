                ...
                completionBlock:(CompletedGetHostingSetup) onCompleted
{
    ...
    if (input.app == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'app' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    [_queryBuilder appendString: @"/s/h"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             HostingModelResponse* _result = (HostingModelResponse*) [APIHelper jsonDeserialize: _strResult
                toClass: HostingModelResponse.class];
