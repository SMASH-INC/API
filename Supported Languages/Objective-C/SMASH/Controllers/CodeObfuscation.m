...
@implementation CodeObfuscation
                ...
                completionBlock:(CompletedGetObfuscationAndAntiTampering) onCompleted
{
    ...
    if (app == nil)
        _validationError = [[APIError alloc] initWithReason: @"The parameter 'app' is a required parameter and cannot be nil."
                                                    andContext:nil];
    ...
    [_queryBuilder appendString: @"/s/o"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             CodeProtectionModelResponse* _result = (CodeProtectionModelResponse*) [APIHelper jsonDeserialize: _strResult
                toClass: CodeProtectionModelResponse.class];
