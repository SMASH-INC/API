...
public class DNS extends BaseController {    
    ...
    public void dNSConfigurationAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5324939878136370253L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5302018352572916359L;
            {
    ...
    public void dNSCreationAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5467544768649184675L;
            {
                    put( "domain", domain );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4738672196672939879L;
            {
                    put( "user-agent", "SMASH" );
            }
        };
