...
public class TwoFactorAuthenticationAPI extends BaseController {    
    ...
    public void m2FATokenResponseAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5632686986437234706L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4806609052982315253L;
            {
    ...
    public void twoFactorAuthenticationAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4871525420228923141L;
            {
                    put( "to", to );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5247601870444429848L;
            {
                    put( "user-agent", "SMASH" );
            }
        };
