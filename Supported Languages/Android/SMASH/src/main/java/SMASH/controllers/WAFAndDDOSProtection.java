...
public class WAFAndDDOSProtection extends BaseController {    
    ...
    public void wAFConfigurationAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4977840217936995022L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5145425698167204736L;
            {
    ...
    public void wAFCreationAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5140744615563622956L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5334827152924336630L;
            {
                    put( "user-agent", "SMASH" );
            }
        };
