...
public class AdvancedLogging extends BaseController {    
    ...
    public void loggingConfigurationAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5256354859008709895L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5023415487080761062L;
            {
    ...
    public void loggingInfoAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5429672180417810143L;
            {
                    put( "name", input.getName() );
                    put( "origin", input.getOrigin() );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4735342732818232595L;
            {
                    put( "user-agent", "SMASH" );
            }
        };
