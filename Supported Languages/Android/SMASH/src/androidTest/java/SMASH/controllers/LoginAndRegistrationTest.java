...
public class LoginAndRegistrationTest extends ControllerTestBase {
    ...
    public void testHttpsApiRestShApiAUR() throws Throwable {
        ...
        APICallBackCatcher<UserRegistrationModelResponse> response = new APICallBackCatcher<UserRegistrationModelResponse>();
        controller.setHttpCallBack(httpResponse);
        controller.userRegistrationAsync(input, queryParams, response);
    ...
    public void testHttpsApiRestShApiAUL() throws Throwable {
        ...
        APICallBackCatcher<UserAuthenticationModelResponse> response = new APICallBackCatcher<UserAuthenticationModelResponse>();
        controller.setHttpCallBack(httpResponse);
        controller.userAuthenticationAsync(input, response);
        result = response.getResult();
