...
/*
 * Input structure for the method HostingSetup
 */
type HostingSetupInput struct {
 ...
 */
type HOSTING_IMPL struct { }

/**
 * Node.JS and Static Web APP Hosting
 * @param  HostingSetupInput     Structure with all inputs
 * @return	Returns the *models_pkg.HostingModelResponse response from the API call
 */
func (me *HOSTING_IMPL) HostingSetup (input *HostingSetupInput) (*models_pkg.HostingModelResponse, error) {
   ...
   _queryBuilder = _queryBuilder + "/s/h"
    ...
    var retVal *models_pkg.HostingModelResponse = &models_pkg.HostingModelResponse{}
