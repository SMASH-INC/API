...
/*
 * Input structure for the method CDNPushZone
 */
type CDNPushZoneInput struct {
    Cname           string          //Domain or domain names separated by a comma you wish to allow CNAME access
    File            string          //GIT URL, file URL, or direct upload of file
}

/*
 * Input structure for the method CDNPullZone
 */
type CDNPullZoneInput struct {
    Origin          string          //Domain or domain names separated by a comma
    Cname           string          //Domain or domain names separated by a comma you wish to allow CNAME access
}
 ...
 */
type CDN_IMPL struct { }

/**
 * CDN Push Zone API
 * @param  CDNPushZoneInput     Structure with all inputs
 * @return	Returns the *models_pkg.CDNPushModelResponse response from the API call
 */
func (me *CDN_IMPL) CDNPushZone (input *CDNPushZoneInput) (*models_pkg.CDNPushModelResponse, error) {
   ...
   _queryBuilder = _queryBuilder + "/s/c/push"
    ...
    var retVal *models_pkg.CDNPushModelResponse = &models_pkg.CDNPushModelResponse{}
...
/**
 * CDN Pull Zone API
 * @param  CDNPullZoneInput     Structure with all inputs
 * @return	Returns the *models_pkg.CDNPullModelResponse response from the API call
 */
func (me *CDN_IMPL) CDNPullZone (input *CDNPullZoneInput) (*models_pkg.CDNPullModelResponse, error) {
   ...
   _queryBuilder = _queryBuilder + "/s/c/pull"
    ...
    //returning the response
    var retVal *models_pkg.CDNPullModelResponse = &models_pkg.CDNPullModelResponse{}
    err = json.Unmarshal(_response.RawBody, &retVal)
