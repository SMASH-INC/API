...
/*
 * Input structure for the method ImageManipulation
 */
type ImageManipulationInput struct {
 ...
 */
type IMAGEMANIPULATION_IMPL struct { }

/**
 * Image Manipulation API
 * @param  ImageManipulationInput     Structure with all inputs
 * @return	Returns the *models_pkg.ImageManipulationModelResponse response from the API call
 */
func (me *IMAGEMANIPULATION_IMPL) ImageManipulation (input *ImageManipulationInput) (*models_pkg.ImageManipulationModelResponse, error) {
   ...
   _queryBuilder = _queryBuilder + "/i"
    ...
    var retVal *models_pkg.ImageManipulationModelResponse = &models_pkg.ImageManipulationModelResponse{}
